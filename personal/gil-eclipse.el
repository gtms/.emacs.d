;;; gil-eclipse-theme.el --- Theme forked from eclipse.el by Oleh Krehel

;; Copyright (C) 2019 Gil Tomás

;; Author: Gil Tomás <gil.tms@gmail.com>
;; URL: https://github.com/gtms/gil-eclipse-theme
;; Package-Version: NA
;; Version: 0.1.0
;; Keywords: themes
...
(let ((class '((class color) (min-colors 88) (background light)))
      (eclipse-bg "white")
      (eclipse-fg "black")
      (eclipse-const "MidnightBlue")
      (eclipse-comment "SteelBlue")
      (eclipse-error "#FF0000")
      (eclipse-builtin "#7F0055")
      (eclipse-string "MediumBlue")
      (eclipse-blue-3 "#758BC6")
      (eclipse-region "thistle")
  ...
  (apply 'custom-theme-set-faces 'eclipse
         (mapcar
          ...
          `((default :foreground ,eclipse-fg :background ,eclipse-bg)
            ...
            (secondary-selection :background "MistyRose" :foreground "Grey50")
            ...
            (font-lock-type-face :foreground "firebrick" :underline nil :slant normal :weight bold)
            ...
            (hl-line :background "WhiteSmoke")
            ;; defaults
            (mode-line-buffer-id)
            (show-paren-match :background "plum")
...
;;; gil-eclipse-theme.el ends here
